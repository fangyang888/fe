"use strict";
(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([["vendors-node_modules_taro_weapp_prebundle_chunk-AKJACZRF_js"],{

/***/ "./node_modules/.taro/weapp/prebundle/chunk-AKJACZRF.js":
/*!**************************************************************!*\
  !*** ./node_modules/.taro/weapp/prebundle/chunk-AKJACZRF.js ***!
  \**************************************************************/
...
/* harmony export */ });
/* harmony import */ var _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-HKRDOLLS.js */ "./node_modules/.taro/weapp/prebundle/chunk-HKRDOLLS.js");
...
/* provided dependency */ var window = __webpack_require__(/*! ./node_modules/.taro/weapp/prebundle/chunk-AKJACZRF.js */ "./node_modules/.taro/weapp/prebundle/chunk-AKJACZRF.js")["window$1"];
/* provided dependency */ var document = __webpack_require__(/*! ./node_modules/.taro/weapp/prebundle/chunk-AKJACZRF.js */ "./node_modules/.taro/weapp/prebundle/chunk-AKJACZRF.js")["document$1"];
/* provided dependency */ var requestAnimationFrame = __webpack_require__(/*! ./node_modules/.taro/weapp/prebundle/chunk-AKJACZRF.js */ "./node_modules/.taro/weapp/prebundle/chunk-AKJACZRF.js")["_raf"];
/* provided dependency */ var cancelAnimationFrame = __webpack_require__(/*! ./node_modules/.taro/weapp/prebundle/chunk-AKJACZRF.js */ "./node_modules/.taro/weapp/prebundle/chunk-AKJACZRF.js")["_caf"];


// node_modules/.pnpm/@tarojs+runtime@3.6.6/node_modules/@tarojs/runtime/dist/runtime.esm.js
var runtime_esm_exports = {};
(0,_chunk_P7VEE7PG_js__WEBPACK_IMPORTED_MODULE_1__.__export)(runtime_esm_exports, {
    Current: ()=>Current,
    Events: ()=>_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.Events,
    ...
    history: ()=>history,
    hooks: ()=>_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks,
    hydrate: ()=>hydrate,
...
function extend(ctor, methodName, options2) {
    if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isFunction)(options2)) {
        options2 = {
            value: options2
        };
    }
...
function getComponentsAlias2() {
    if (!componentsAlias$1) {
        componentsAlias$1 = (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.getComponentsAlias)(_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.internalComponents);
    }
...
function hydrate(node) {
    ...
    if (!SPECIAL_NODES) {
        SPECIAL_NODES = _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.call("getSpecialNodes");
    }
    ...
    for(const prop in props){
        const propInCamelCase = (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.toCamelCase)(prop);
    ...
    _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.call("modifyHydrateData", data);
    const nn = data["nn"];
...
function setStyle(newVal, styleKey) {
    (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.warn)((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isString)(newVal) && newVal.length > PROPERTY_THRESHOLD, `Style \u5C5E\u6027 ${styleKey} \u7684\u503C\u6570\u636E\u91CF\u8FC7\u5927\uFF0C\u53EF\u80FD\u4F1A\u5F71\u54CD\u6E32\u67D3\u6027\u80FD\uFF0C\u8003\u8651\u4F7F\u7528 CSS \u7C7B\u6216\u5176\u5B83\u65B9\u6848\u66FF\u4EE3\u3002`);
    const old = this[styleKey];
    if (old === newVal) return;
    !this._pending && recordCss(this);
    if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isNull)(newVal) || (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isUndefined)(newVal)) {
    ...
    for(let i = 0; i < styleProperties2.length; i++){
        ...
        properties[styleKey] = {
            get () {
                ...
                return (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isNull)(val) || (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isUndefined)(val) ? "" : val;
            },
            set (newVal) {
...
function format(children, document2, styleOptions, parent) {
    return children.filter((child)=>{
        ...
        if (child.type === "text") {
            ...
            if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isFunction)(options.html.transformText)) {
        ...
        if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isFunction)(options.html.transformElement)) {
...
function getEventCBResult(event) {
    ...
    if (!(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isUndefined)(result)) {
...
function eventHandler(event) {
    ...
    _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.call("modifyMpEventImpl", event);
    ...
    if (node) {
        const dispatch = ()=>{
            ...
            _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.call("modifyTaroEvent", e, node);
            node.dispatchEvent(e);
        };
        if (_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.isExist("batchedEventUpdates")) {
            const type = event.type;
            if (!_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.call("isBubbleEvents", type) || !isParentBinded(node, type) || type === TOUCHMOVE && !!node.props.catchMove) {
                _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.call("batchedEventUpdates", ()=>{
                    if (eventsBatch[type]) {
...
function findCustomWrapper(root, dataPathArr) {
    ...
    list.some((item, i)=>{
        ...
        if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isArray)(currentData)) {
            currentData = currentData.filter((el)=>!isComment(el));
        }
        if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isUndefined)(currentData)) return true;
...
function appendTo(dict, name, value) {
    const res = (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isArray)(value) ? value.join(",") : value;
...
function parseUrl(url = "") {
    ...
    if (!url || !(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isString)(url)) return result;
    url = url.trim();
    const PATTERN = /^(([^:/?#]+):)?\/\/(([^/?#]+):(.+)@)?([^/?#:]*)(:(\d+))?([^?#]*)(\?([^#]*))?(#(.*))?/;
...
function parseUrlBase(url, base) {
    ...
    let fullUrl = "";
    let parsedBase = null;
    if (!(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isUndefined)(base)) {
...
function injectPageInstance(inst, id) {
    _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.call("mergePageInstance", instances.get(id), inst);
...
function safeExecute(path, lifecycle, ...args) {
    ...
    const func = _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.call("getLifecycle", instance, lifecycle);
    if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isArray)(func)) {
        const res = func.map((fn)=>fn.apply(instance, args));
        return res[0];
    }
    if (!(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isFunction)(func)) {
        return;
    }
...
function createPageConfig(component, pageName, data, pageConfig) {
    ...
    const [ONLOAD, ONUNLOAD, ONREADY, ONSHOW, ONHIDE, LIFECYCLES, SIDE_EFFECT_LIFECYCLES] = _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.call("getMiniLifecycleImpl").page;
    ...
    function setCurrentRouter(page) {
        ...
        if (!(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isUndefined)(page.exitState)) {
        ...
        [ONLOAD] (options2 = {}, cb) {
            ...
            const mount = ()=>{
                Current.app.mount(component, $taroPath, ()=>{
                    ...
                    (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.ensure)(pageElement !== null, "\u6CA1\u6709\u627E\u5230\u9875\u9762\u5B9E\u4F8B\u3002");
                    ...
                    if (!isWeb) {
                        ...
                        (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isFunction)(cb) && cb();
                    }
                });
            };
            if (unmounting) {
    ...
    if (!(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isUndefined)(data)) {
        config.data = data;
    }
    _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.call("modifyPageObject", config);
    return config;
}
function createComponentConfig(component, componentName, data) {
    const id = componentName !== null && componentName !== void 0 ? componentName : `taro_component_${pageId()}`;
    let componentElement = null;
    const [ATTACHED, DETACHED] = _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.call("getMiniLifecycleImpl").component;
    const config = {
        [ATTACHED] () {
            var _a;
            perf.start(PAGE_INIT);
            ...
            Current.app.mount(component, path, ()=>{
                ...
                (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.ensure)(componentElement !== null, "\u6CA1\u6709\u627E\u5230\u7EC4\u4EF6\u5B9E\u4F8B\u3002");
    ...
    [
        ...
        var _a;
        config[key] = (_a = component[key]) !== null && _a !== void 0 ? _a : _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.EMPTY_OBJ;
    });
    return config;
}
function createRecursiveComponentConfig(componentName) {
    ...
    const lifeCycles = isCustomWrapper ? {
        [ATTACHED] () {
            ...
            if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isString)(componentId)) {
    ...
    } : _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.EMPTY_OBJ;
    return Object.assign({
        properties: {
            i: {
                type: Object,
                value: {
                    ["nn"]: (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.getComponentsAlias)(_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.internalComponents)[VIEW]._num
                }
            },
            l: {
                type: String,
...
var init_runtime_esm = (0,_chunk_P7VEE7PG_js__WEBPACK_IMPORTED_MODULE_1__.__esm)({
    "node_modules/.pnpm/@tarojs+runtime@3.6.6/node_modules/@tarojs/runtime/dist/runtime.esm.js" () {
        (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.init_shared_esm)();
        (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.init_shared_esm)();
        ...
        MutationObserver = class {
            ...
            constructor(callback){
                if (false) {} else {
                    ...
                    this.core = {
                        observe: _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.noop,
                        disconnect: _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.noop,
                        takeRecords: _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.noop
                    };
                }
            }
        };
        ...
        isWeb$1 = (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isWebPlatform)();
        env = {
            window: isWeb$1 ? window : _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.EMPTY_OBJ,
            document: isWeb$1 ? document : _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.EMPTY_OBJ
        };
        TaroEventTarget = class {
            addEventListener(type, handler, options2) {
                type = type.toLowerCase();
                _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.call("onAddEvent", type, handler, options2, this);
                ...
                let isOnce = false;
                if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isObject)(options2)) {
                ...
                (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.warn)(isCapture, "Taro \u6682\u672A\u5B9E\u73B0 event \u7684 capture \u7279\u6027\u3002");
                ...
                if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isArray)(handlers)) {
            ...
            removeEventListener(type, handler) {
                ...
                (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.warn)(index === -1, `\u4E8B\u4EF6: '${type}' \u6CA1\u6709\u6CE8\u518C\u5728 DOM \u4E2D\uFF0C\u56E0\u6B64\u4E0D\u4F1A\u88AB\u79FB\u9664\u3002`);
        ...
        TaroNode = class extends TaroEventTarget {
            ...
            findIndex(refChild) {
                ...
                (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.ensure)(index !== -1, "The node to be replaced is not a child of this node.");
                return index;
            }
            get _path() {
                ...
                if (parentNode) {
                    ...
                    const index = _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.call("getPathIndex", indexOfNode);
        ...
        Style = class {
            ...
            get cssText() {
                ...
                this._usedStyleProp.forEach((key)=>{
                    const val = this[key];
                    if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isNull)(val) || (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isUndefined)(val)) return;
                    let styleName = isCssVariable(key) ? key : (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.toDashed)(key);
            ...
            set cssText(str) {
                ...
                if (str === "" || (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isUndefined)(str) || (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isNull)(str)) {
                    this._pending = false;
                    enqueueUpdate(this);
                    return;
                }
                ...
                for(let i = 0; i < rules.length; i++){
                    ...
                    if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isUndefined)(val)) {
                        continue;
                    }
            ...
            setProperty(propertyName, value) {
                if (propertyName[0] === "-") {
                    ...
                    propertyName = (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.toCamelCase)(propertyName);
                }
                if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isNull)(value) || (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isUndefined)(value)) {
        ...
        _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.tap("injectNewStyleProperties", (newStyleProperties)=>{
            if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isArray)(newStyleProperties)) {
        ...
        TaroElement = class extends TaroNode {
            _stopPropagation(event) {
                ...
                while(target = target.parentNode){
                    ...
                    if (!(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isArray)(listeners)) {
                        continue;
                    }
            ...
            hasAttribute(qualifiedName) {
                return !(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isUndefined)(this.props[qualifiedName]);
            }
            hasAttributes() {
            ...
            setAttribute(qualifiedName, value) {
                (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.warn)((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isString)(value) && value.length > PROPERTY_THRESHOLD, `\u5143\u7D20 ${this.nodeName} \u7684 ${qualifiedName} \u5C5E\u6027\u503C\u6570\u636E\u91CF\u8FC7\u5927\uFF0C\u53EF\u80FD\u4F1A\u5F71\u54CD\u6E32\u67D3\u6027\u80FD\u3002\u8003\u8651\u964D\u4F4E\u56FE\u7247\u8F6C\u4E3A base64 \u7684\u9608\u503C\u6216\u5728 CSS \u4E2D\u4F7F\u7528 base64\u3002`);
                ...
                switch(qualifiedName){
                    ...
                    default:
                        ...
                        if (qualifiedName.startsWith("data-")) {
                            if (this.dataset === _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.EMPTY_OBJ) {
                                this.dataset = /* @__PURE__ */ Object.create(null);
                            }
                            this.dataset[(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.toCamelCase)(qualifiedName.replace(/^data-/, ""))] = value;
                        }
                        break;
                }
                ...
                const qualifiedNameInCamelCase = (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.toCamelCase)(qualifiedName);
                const payload = {
                    path: `${_path}.${qualifiedNameInCamelCase}`,
                    value: (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isFunction)(value) ? ()=>value : value
                };
                _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.call("modifySetAttrPayload", this, qualifiedName, payload, componentsAlias2);
                if (_alias) {
                    const qualifiedNameAlias = _alias[qualifiedNameInCamelCase] || qualifiedName;
                    payload.path = `${_path}.${(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.toCamelCase)(qualifiedNameAlias)}`;
                }
            ...
            removeAttribute(qualifiedName) {
                ...
                if (qualifiedName === STYLE) {
                    ...
                    const isInterrupt = _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.call("onRemoveAttribute", this, qualifiedName);
                    if (isInterrupt) {
                        return;
                    }
                ...
                _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.call("modifyRmAttrPayload", this, qualifiedName, payload, componentsAlias2);
                if (_alias) {
                    const qualifiedNameAlias = _alias[qualifiedNameInCamelCase] || qualifiedName;
                    payload.path = `${_path}.${(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.toCamelCase)(qualifiedNameAlias)}`;
                }
            ...
            dispatchEvent(event) {
                ...
                for(let i = listeners.length; i--;){
                    ...
                    if (listener._stop) {
                        ...
                        _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.call("modifyDispatchEvent", event, this);
                        result = listener.call(this, event);
                    }
                    if ((result === false || event._end) && cancelable) {
                        event.defaultPrevented = true;
                    }
                    if (!(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isUndefined)(result) && event.mpEvent) {
            ...
            addEventListener(type, handler, options2) {
                ...
                const SPECIAL_NODES2 = _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.call("getSpecialNodes");
                let sideEffect = true;
                if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isObject)(options2) && options2.sideEffect === false) {
                    sideEffect = false;
            ...
            constructor(){
                super();
                this.props = {};
                this.dataset = _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.EMPTY_OBJ;
                this.nodeType = 1;
                this.style = new Style(this);
                _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.call("patchElement", this);
            }
        };
        options = {
            prerender: true,
        ...
        internalCompsList = Object.keys(_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.internalComponents).map((i)=>i.toLowerCase()).join(",");
        ...
        if (!(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isWebPlatform)()) {
            if (true) {
        ...
        TaroEvent = class {
            ...
            get target() {
                ...
                if (!cacheTarget) {
                    ...
                    target.dataset = element !== null ? element.dataset : _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.EMPTY_OBJ;
            ...
            performUpdate(initRender = false, prerender) {
                ...
                setTimeout(()=>{
                    ...
                    for(const path1 in data){
                        ...
                        if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isFunction)(value1)) {
                            data[path1] = value1();
                        }
                    }
                    if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isFunction)(prerender)) return prerender(data);
        ...
        URLSearchParams = class {
            ...
            constructor(query){
                ...
                if (typeof query === "string") {
                    ...
                    if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isArray)(query)) {
        ...
        URL = class {
            ...
            set protocol(val) {
                (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isString)(val) && __classPrivateFieldSet(this, _URL_protocol, val.trim(), "f");
            }
            get host() {
                return this.hostname + (this.port ? ":" + this.port : "");
            }
            set host(val) {
                if (val && (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isString)(val)) {
                    val = val.trim();
            ...
            set hostname(val) {
                val && (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isString)(val) && __classPrivateFieldSet(this, _URL_hostname, val.trim(), "f");
            }
            get port() {
                return __classPrivateFieldGet(this, _URL_port, "f");
            }
            set port(val) {
                (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isString)(val) && __classPrivateFieldSet(this, _URL_port, val.trim(), "f");
            }
            get pathname() {
                return __classPrivateFieldGet(this, _URL_pathname, "f");
            }
            set pathname(val) {
                if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isString)(val)) {
                    val = val.trim();
                    const HEAD_REG = /^(\/|\.\/|\.\.\/)/;
                    let temp = val;
            ...
            constructor(url, base){
                ...
                if (!(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isString)(url)) url = String(url);
        ...
        TaroDocument = class extends TaroElement {
            createElement(type) {
                ...
                switch(true){
                    case nodeName === ROOT_STR:
                        ...
                        return element;
                    case _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.controlledComponent.has(nodeName):
            ...
            getElementById(id) {
                ...
                return (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isUndefined)(el) ? null : el;
            }
            querySelector(query) {
                if (/^#/.test(query)) {
        ...
        eventCenter = _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.hooks.call("getEventCenter", _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.Events);
        RuntimeCache = class {
            has(identifier) {
        ...
        History = class extends _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.Events {
            get length() {
            ...
            go(delta) {
                if (!(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isNumber)(delta) || isNaN(delta)) return;
            ...
            pushState(state, title, url) {
                if (!url || !(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isString)(url)) return;
        ...
        Location = class extends _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.Events {
            get protocol() {
                return __classPrivateFieldGet(this, _Location_url, "f").protocol;
            }
            set protocol(val) {
                const REG = /^(http|https):$/i;
                if (!val || !(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isString)(val) || !REG.test(val.trim())) return;
                val = val.trim();
            ...
            set host(val) {
                if (!val || !(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isString)(val)) return;
                val = val.trim();
                const preValue = __classPrivateFieldGet(this, _Location_instances, "m", _Location_getPreValue).call(this);
            ...
            set port(val) {
                ...
                if (!(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isNumber)(xVal) || xVal <= 0) return;
                const preValue = __classPrivateFieldGet(this, _Location_instances, "m", _Location_getPreValue).call(this);
            ...
            set href(val) {
                ...
                if (!val || !(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isString)(val) || !REG.test(val = val.trim())) return;
                const preValue = __classPrivateFieldGet(this, _Location_instances, "m", _Location_getPreValue).call(this);
            ...
            assign() {
                (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.warn)(true, "\u5C0F\u7A0B\u5E8F\u73AF\u5883\u4E2D\u8C03\u7528location.assign()\u65E0\u6548.");
            }
            reload() {
                (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.warn)(true, "\u5C0F\u7A0B\u5E8F\u73AF\u5883\u4E2D\u8C03\u7528location.reload()\u65E0\u6548.");
            }
            replace(url) {
        ...
        nav = (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isWebPlatform)() ? env.window.navigator : {
            appCodeName: "Mozilla",
            appName: "Netscape",
            appVersion: "5.0 " + msg,
            cookieEnabled: true,
        ...
        if (!(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isWebPlatform)()) {
            class Window extends _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.Events {
                initEvent() {
                ...
                addEventListener(event, callback) {
                    if (!(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isString)(event)) return;
        ...
        pageId = incrementId();
        isWeb = (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_0__.isWebPlatform)();
        nextTick = (cb, ctx)=>{
            var _a, _b, _c;
