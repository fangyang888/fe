...
// node_modules/.pnpm/@tarojs+plugin-framework-react@3.6.6_gmfjyjnfrpegzlyrr3wjgyijui/node_modules/@tarojs/plugin-framework-react/dist/runtime.js
(0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_1__.init_shared_esm)();
(0,_chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.init_runtime_esm)();
var reactMeta = {
    PageContext: _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_1__.EMPTY_OBJ,
    R: _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_1__.EMPTY_OBJ
};
...
function isClassComponent(R, component) {
    ...
    return (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_1__.isFunction)(component.render) || !!(prototype === null || prototype === void 0 ? void 0 : prototype.isReactComponent) || prototype instanceof R.Component;
}
function ensureIsArray(item) {
    if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_1__.isArray)(item)) {
        return item;
    } else {
        return item ? [
            item
...
function setRouterParams(options) {
    _chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.Current.router = Object.assign({
...
var createTaroHook = (lifecycle)=>{
    return (fn)=>{
        ...
        React.useLayoutEffect(()=>{
            let inst = instRef.current = (0,_chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.getPageInstance)(id);
            let first = false;
            if (!inst) {
                first = true;
            ...
            if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_1__.isFunction)(inst[lifecycle])) {
                inst[lifecycle] = [
                    inst[lifecycle],
                    callback
                ];
            ...
            if (first) {
                (0,_chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.injectPageInstance)(inst, id);
            }
            return ()=>{
                ...
                } else if ((0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_1__.isArray)(list)) {
...
var useRouter = (dynamic = false)=>{
    ...
    return dynamic ? _chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.Current.router : React.useMemo(()=>_chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.Current.router, []);
};
...
var ReactDOM$1;
var Fragment;
var pageKeyId = (0,_chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.incrementId)();
var isWeb = (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_1__.isWebPlatform)();
function setReconciler(ReactDOM2) {
    _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_1__.hooks.tap("getLifecycle", function(instance, lifecycle) {
        lifecycle = lifecycle.replace(/^on(Show|Hide)$/, "componentDid$1");
        return instance[lifecycle];
    });
    _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_1__.hooks.tap("modifyMpEvent", function(event) {
        Object.defineProperty(event, "type", {
            value: event.type.replace(/-/g, "")
        });
    });
    _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_1__.hooks.tap("batchedEventUpdates", function(cb) {
        ReactDOM2.unstable_batchedUpdates(cb);
    });
    _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_1__.hooks.tap("mergePageInstance", function(prev, next) {
        if (!prev || !next) return;
    ...
    if (isWeb) {
        _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_1__.hooks.tap("createPullDownComponent", (el, _, R, customWrapper)=>{
        ...
        _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_1__.hooks.tap("getDOMNode", (inst)=>{
...
function connectReactPage(R, id) {
    return (Page)=>{
        ...
        const inject = (node)=>node && (0,_chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.injectPageInstance)(node, id);
        const refs = isReactComponent ? {
            ref: inject
        } : {
            forwardedRef: inject,
        ...
        if (reactMeta.PageContext === _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_1__.EMPTY_OBJ) {
            reactMeta.PageContext = R.createContext("");
        }
        return class PageWrapper extends R.Component {
            static getDerivedStateFromError(error) {
                var _a, _b;
                (_b = (_a = _chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.Current.app) === null || _a === void 0 ? void 0 : _a.onError) === null || _b === void 0 ? void 0 : _b.call(_a, error.message + error.stack);
                return {
                    hasError: true
                };
            }
...
function createReactApp(App, react, dom, config) {
    if (true) {
        (0,_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_1__.ensure)(!!dom, "\u6784\u5EFA React/Nerv \u9879\u76EE\u8BF7\u628A process.env.FRAMEWORK \u8BBE\u7F6E\u4E3A 'react'/'nerv' ");
    }
    reactMeta.R = react;
    ...
    function renderReactRoot() {
        ...
        const container = _chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.document$1.getElementById(appId);
    ...
    const [ONLAUNCH, ONSHOW, ONHIDE] = _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_1__.hooks.call("getMiniLifecycleImpl").app;
    ...
    function triggerAppHook(lifecycle, ...option) {
        const instance = (0,_chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.getPageInstance)(HOOKS_APP_ID);
        if (instance) {
            const app = getAppInstance();
            const func = _chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_1__.hooks.call("getLifecycle", instance, lifecycle);
            if (Array.isArray(func)) {
                func.forEach((cb)=>cb.apply(app, option));
            }
        }
    }
    _chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.Current.app = appObj;
    return appObj;
}
var getNativeCompId = (0,_chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.incrementId)();
var h;
var ReactDOM;
function initNativeComponentEntry(R, ReactDOM2) {
    ...
    class Entry extends R.Component {
        componentDidMount() {
            _chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.Current.app = this;
        }
        mount(Component, compId, getCtx) {
            const isReactComponent = isClassComponent(R, Component);
            const inject = (node)=>node && (0,_chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.injectPageInstance)(node, compId);
            const refs = isReactComponent ? {
                ref: inject
            } : {
                forwardedRef: inject,
        ...
        unmount(compId) {
            ...
            this.setState({
                ...
                (0,_chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.removePageInstance)(compId);
            });
        }
        render() {
            const components = this.state.components;
    ...
    const app = _chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.document$1.getElementById("app");
...
function createNativeComponentConfig(Component, react, reactdom, componentConfig) {
    ...
    const componentObj = {
        ...
        created () {
            if (!_chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.Current.app) {
        ...
        attached () {
            ...
            _chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.Current.app.mount(Component, compId, ()=>this);
        },
        ready () {
            (0,_chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.safeExecute)(this.compId, "onReady");
        },
        detached () {
            resetCurrent();
            _chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.Current.app.unmount(this.compId);
        },
        pageLifetimes: {
            show (options) {
                (0,_chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.safeExecute)(this.compId, "onShow", options);
            },
            hide () {
                (0,_chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.safeExecute)(this.compId, "onHide");
            }
        },
        methods: {
            eh: _chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.eventHandler,
            onLoad (options) {
                (0,_chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.safeExecute)(this.compId, "onLoad", options);
            },
            onUnload () {
                (0,_chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.safeExecute)(this.compId, "onUnload");
            }
        }
    };
    function resetCurrent() {
        _chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.Current.page = null;
        _chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.Current.router = null;
    }
    function setCurrent(compId) {
        const pages = getCurrentPages();
        const currentPage = pages[pages.length - 1];
        if (_chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.Current.page === currentPage) return;
        _chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.Current.page = currentPage;
        const route = currentPage.route || currentPage.__route__;
        const router = {
            params: currentPage.options || {},
            path: (0,_chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.addLeadingSlash)(route),
            $taroPath: compId,
            onReady: "",
            onHide: "",
            onShow: ""
        };
        _chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.Current.router = router;
    ...
    if (Component.onShareAppMessage || ((_a = Component.prototype) === null || _a === void 0 ? void 0 : _a.onShareAppMessage) || Component.enableShareAppMessage) {
        componentObj.methods.onShareAppMessage = function(options) {
            ...
            if (target) {
                const id = target.id;
                const element = _chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.document$1.getElementById(id);
                if (element) {
                    target.dataset = element.dataset;
                }
            }
            return (0,_chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.safeExecute)(this.compId, "onShareAppMessage", options);
        };
    }
    if (Component.onShareTimeline || ((_b = Component.prototype) === null || _b === void 0 ? void 0 : _b.onShareTimeline) || Component.enableShareTimeline) {
        componentObj.methods.onShareTimeline = function() {
            return (0,_chunk_AKJACZRF_js__WEBPACK_IMPORTED_MODULE_0__.safeExecute)(this.compId, "onShareTimeline");
        };
    }
    return componentObj;
}
_chunk_HKRDOLLS_js__WEBPACK_IMPORTED_MODULE_1__.hooks.tap("initNativeApi", function(taro) {
